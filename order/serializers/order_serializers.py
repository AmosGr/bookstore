...
class OrderSerializer(serializers.ModelSerializer):
    ...
    # O metodo é identificado quando usamos get_nomedometodo
    ...
    def create(self,validated_data):
        ...
        product_data = validated_data.pop('products_id') # Remove products_id das informações do produto na ordem
